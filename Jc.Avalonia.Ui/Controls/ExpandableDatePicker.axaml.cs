...
[TemplatePart("PART_PickerPresenter", typeof(ExpandableDatePickerPresenter))]
[TemplatePart("PART_Popup", typeof(ExpanderlessExpander))]
...
public partial class ExpandableDatePicker : TemplatedControl
{
    ...
    public static readonly StyledProperty<double> MaxDropDownHeightProperty =
        AvaloniaProperty.Register<ExpandableDatePicker, double>(
    ...
    public static readonly StyledProperty<string> DayFormatProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, string>(nameof(DayFormat), "%d");

    /// <summary>
    /// Defines the <see cref="DayVisible"/> Property
    /// </summary>
    public static readonly StyledProperty<bool> DayVisibleProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, bool>(nameof(DayVisible), true);

    /// <summary>
    /// Defines the <see cref="MaxYear"/> Property
    /// </summary>
    public static readonly StyledProperty<DateTimeOffset> MaxYearProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, DateTimeOffset>(nameof(MaxYear),
            DateTimeOffset.MaxValue, coerce: CoerceMaxYear);

    /// <summary>
    /// Defines the <see cref="MinYear"/> Property
    /// </summary>
    public static readonly StyledProperty<DateTimeOffset> MinYearProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, DateTimeOffset>(nameof(MinYear),
            DateTimeOffset.MinValue, coerce: CoerceMinYear);

    /// <summary>
    /// Defines the <see cref="MonthFormat"/> Property
    /// </summary>
    public static readonly StyledProperty<string> MonthFormatProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, string>(nameof(MonthFormat), "MMMM");

    /// <summary>
    /// Defines the <see cref="MonthVisible"/> Property
    /// </summary>
    public static readonly StyledProperty<bool> MonthVisibleProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, bool>(nameof(MonthVisible), true);

    /// <summary>
    /// Defines the <see cref="YearFormat"/> Property
    /// </summary>
    public static readonly StyledProperty<string> YearFormatProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, string>(nameof(YearFormat), "yyyy");

    /// <summary>
    /// Defines the <see cref="YearVisible"/> Property
    /// </summary>
    public static readonly StyledProperty<bool> YearVisibleProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, bool>(nameof(YearVisible), true);

    /// <summary>
    /// Defines the <see cref="SelectedDate"/> Property
    /// </summary>
    public static readonly StyledProperty<DateTimeOffset?> SelectedDateProperty =
        AvaloniaProperty.Register<global::Avalonia.Controls.DatePicker, DateTimeOffset?>(nameof(SelectedDate),
    ...
    // private static void OnGridVisibilityChanged(global::Avalonia.Controls.DatePicker sender, AvaloniaPropertyChangedEventArgs e) => sender.SetGrid();
    ...
    private static DateTimeOffset CoerceMinYear(AvaloniaObject sender, DateTimeOffset value)
    {
        if (value > sender.GetValue(MaxYearProperty))
        {
            throw new InvalidOperationException(
                $"{MinYearProperty.Name} cannot be greater than {MaxYearProperty.Name}");
        }
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        if (_popup != null)
        {
            _popup.Expanded -= OnPopupExpanded;
            _popup.Collapsed -= OnPopupCollapsed;
        }
        if (_presenter != null)
        {
        ...
        _popup = e.NameScope.Find<ExpanderlessExpander>("PART_Popup");
    ...
    private void OnPopupCollapsed(object? sender, RoutedEventArgs e)
    {
        // TODO anything needed here?
    }

    private void OnPopupExpanded(object? sender, RoutedEventArgs e)
    {
        if (_presenter == null)
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == DayVisibleProperty || change.Property == MonthVisibleProperty ||
        ...
        else if (change.Property == MonthFormatProperty || change.Property == YearFormatProperty ||
    ...
    //     _popup.PlacementAnchor = global::Avalonia.Controls.Primitives.PopupPositioning.PopupAnchor.Bottom;
    //     _popup.PlacementGravity = global::Avalonia.Controls.Primitives.PopupPositioning.PopupGravity.Bottom;
    //     _popup.PlacementConstraintAdjustment = global::Avalonia.Controls.Primitives.PopupPositioning.PopupPositionerConstraintAdjustment.SlideY;
    //     _popup.IsOpen = true;
    //
