...
internal partial class CarouselViewScrollViewer : ContentControl, IScrollable, IScrollAnchorProvider
    {
        /// <summary>
        /// Defines the <see cref="Offset"/> property.
        /// </summary>
        public static readonly StyledProperty<Vector> OffsetProperty =
            AvaloniaProperty.Register<CarouselViewScrollViewer, Vector>(nameof(Offset), coerce: CoerceOffset);

        /// <summary>
        /// Defines the <see cref="Extent"/> property.
        /// </summary>
        public static readonly DirectProperty<CarouselViewScrollViewer, Size> ExtentProperty =
            AvaloniaProperty.RegisterDirect<CarouselViewScrollViewer, Size>(nameof(Extent),
                o => o.Extent);

        /// <summary>
        /// Defines the <see cref="Viewport"/> property.
        /// </summary>
        public static readonly DirectProperty<CarouselViewScrollViewer, Size> ViewportProperty =
            AvaloniaProperty.RegisterDirect<CarouselViewScrollViewer, Size>(nameof(Viewport),
                o => o.Viewport);
        ...
        public static readonly AttachedProperty<SnapPointsType> HorizontalSnapPointsTypeProperty =
            ScrollViewer.HorizontalSnapPointsTypeProperty.AddOwner<CarouselViewScrollViewer>();

        /// <summary>
        /// Defines the <see cref="EnableTransition"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> EnableTransitionProperty =
            AvaloniaProperty.Register<CarouselViewScrollViewer, bool>(nameof(EnableTransition), defaultValue: true);
        ...
        public static readonly StyledProperty<TimeSpan?> TransitionDurationProperty =
            AvaloniaProperty.Register<CarouselViewScrollViewer, TimeSpan?>(nameof(TransitionDuration), defaultValue: TimeSpan.FromMilliseconds(500));
        ...
        public static readonly AttachedProperty<SnapPointsType> VerticalSnapPointsTypeProperty =
            ScrollViewer.VerticalSnapPointsTypeProperty.AddOwner<CarouselViewScrollViewer>();
        ...
        public static readonly AttachedProperty<SnapPointsAlignment> HorizontalSnapPointsAlignmentProperty =
            ScrollViewer.HorizontalSnapPointsAlignmentProperty.AddOwner<CarouselViewScrollViewer>();
        ...
        public static readonly AttachedProperty<SnapPointsAlignment> VerticalSnapPointsAlignmentProperty =
            ScrollViewer.VerticalSnapPointsAlignmentProperty.AddOwner<CarouselViewScrollViewer>();
        ...
        static CarouselViewScrollViewer()
        {
            EnableTransitionProperty.Changed.AddClassHandler<CarouselViewScrollViewer>((x, e) => x.AttachTransitions());
            TransitionDurationProperty.Changed.AddClassHandler<CarouselViewScrollViewer>((x, e) => x.AttachTransitions());
        }

        public CarouselViewScrollViewer()
        {
            PropertyChanged += CarouselViewScrollViewer_PropertyChanged;
        }

        private void CarouselViewScrollViewer_PropertyChanged(object? sender, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        private void Presenter_PropertyChanged(object? sender, AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.Property == ScrollContentPresenter.OffsetProperty && e.Priority != BindingPriority.Animation)
            {
        ...
        private void AttachPresenter(ScrollContentPresenter presenter)
        {
            ...
            {
                IfUnset(ScrollContentPresenter.OffsetProperty, p => presenter.Bind(p, this.GetBindingObservable(CarouselViewScrollViewer.OffsetProperty), BindingPriority.Template)),
                IfUnset(ContentProperty, p => presenter.Bind(p, this.GetBindingObservable(ContentProperty), BindingPriority.Template)),
            ...
            presenter.AddHandler(CarouselViewScrollViewGestureRecognizer.ScrollGesturePointerPressedEvent, OnScrollGesture);
            AddHandler(CarouselViewScrollViewGestureRecognizer.ScrollGesturePointerReleasedEvent, OnScrollGestureEnded);
