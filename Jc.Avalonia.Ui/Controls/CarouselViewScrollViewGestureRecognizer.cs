...
public class CarouselViewScrollViewGestureRecognizer : GestureRecognizer
{
    public static readonly RoutedEvent<PointerPressedEventArgs> ScrollGesturePointerPressedEvent =
        RoutedEvent.Register<PointerPressedEventArgs>(
            "ScrollGesturePointerPressed", RoutingStrategies.Bubble, typeof(CarouselViewScrollViewGestureRecognizer));
    public static readonly RoutedEvent<PointerReleasedEventArgs> ScrollGesturePointerReleasedEvent =
        RoutedEvent.Register<PointerReleasedEventArgs>(
            "ScrollGesturePointerReleased", RoutingStrategies.Bubble, typeof(CarouselViewScrollViewGestureRecognizer));
    public static readonly RoutedEvent<PointerEventArgs> ScrollGesturePointerLostEvent =
        RoutedEvent.Register<PointerEventArgs>(
            "ScrollGesturePointerLost", RoutingStrategies.Bubble, typeof(CarouselViewScrollViewGestureRecognizer));
    ...
    /// </summary>
    public static readonly DirectProperty<CarouselViewScrollViewGestureRecognizer, bool> CanHorizontallyScrollProperty =
        AvaloniaProperty.RegisterDirect<CarouselViewScrollViewGestureRecognizer, bool>(nameof(CanHorizontallyScroll),
            o => o.CanHorizontallyScroll, (o, v) => o.CanHorizontallyScroll = v);

    /// <summary>
    /// Defines the <see cref="CanVerticallyScroll"/> property.
    /// </summary>
    public static readonly DirectProperty<CarouselViewScrollViewGestureRecognizer, bool> CanVerticallyScrollProperty =
        AvaloniaProperty.RegisterDirect<CarouselViewScrollViewGestureRecognizer, bool>(nameof(CanVerticallyScroll),
            o => o.CanVerticallyScroll, (o, v) => o.CanVerticallyScroll = v);

    /// <summary>
    /// Defines the <see cref="ScrollStartDistance"/> property.
    /// </summary>
    public static readonly DirectProperty<CarouselViewScrollViewGestureRecognizer, int> ScrollStartDistanceProperty =
        AvaloniaProperty.RegisterDirect<CarouselViewScrollViewGestureRecognizer, int>(nameof(ScrollStartDistance),
