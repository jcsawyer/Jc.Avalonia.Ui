...
/// <summary>
/// Adapted from https://github.com/SuperJMN-Zafiro/Zafiro.Avalonia/blob/master/src/Zafiro.Avalonia/Behaviors/NumberBoxBehavior.cs
/// </summary>
public class NumberBoxBehavior : Behavior<TextBox>
{
    ...
    protected override void OnAttachedToVisualTree()
    {
        ...
        Observable.FromEventPattern<TextInputEventArgs>(
                add => AssociatedObject?.AddHandler(InputElement.TextInputEvent, add, RoutingStrategies.Tunnel),
                remove => AssociatedObject?.RemoveHandler(InputElement.TextInputEvent, remove))
    ...
    private static bool IsValid(string str, string? currentText)
    {
        ...
        return decimal.TryParse(str, NumberStyles.AllowDecimalPoint | NumberStyles.AllowLeadingSign,
